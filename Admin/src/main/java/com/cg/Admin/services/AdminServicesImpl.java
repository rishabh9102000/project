...
public class AdminServicesImpl implements AdminServices{
	...
	public String removeCity(int cityId) throws IdNotFoundException {
		City city = cityrepo.findById(cityId).orElseThrow(()-> new IdNotFoundException("Id not found : " + cityId));
	...
	public Movies addMovies(Movies movie) throws IdNotFoundException {
		moviesrepo.save(movie);
		Movies movieo = moviesrepo.findById(movie.getMovieId()).orElseThrow(()-> new IdNotFoundException("movieId not found : " + movie.getMovieId()));
...
//			System.out.println(i);
	...
	public Theatre getTheatre(int theatreId) throws IdNotFoundException{
		return theatrerepo.findById(theatreId).orElseThrow(()-> new IdNotFoundException("theaterId not found : " + theatreId));
	}
